...
$azcopyUrl = "https://solliancepublicdata.blob.core.windows.net/mcw-lineofbusiness/azcopy_windows_amd64_10.20.1.zip"
...
$azcopy = "$opsDir\azcopy_windows_amd64_10.20.1\azcopy.exe"
